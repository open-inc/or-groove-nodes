...
GrovePiWrapper.prototype.LCDOutput = function(pin, text, color) {
  ...
  i2c1.writeByteSync(0x62, 0x04, color[0])
  i2c1.writeByteSync(0x62, 0x03, color[1])
  i2c1.writeByteSync(0x62, 0x02, color[2])
  ...
  for (var i = 0; i < line1.length; i++) {
    i2c1.writeByteSync(0x3e, 0x40, line1[i].charCodeAt(0));
  }
  ...
  for (var i = 0; i < line2.length; i++) {
    i2c1.writeByteSync(0x3e, 0x40, line2[i].charCodeAt(0));
  }
